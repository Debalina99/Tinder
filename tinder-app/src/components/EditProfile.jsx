                ...
                <div className="flex justify-center gap-3">
                        ...
                        <label>
                            <input
                                type="checkbox"
                                value="90's-kid"
                                checked={profileData.interests.includes("90's-kid")}
                                onChange={handleInterestsChange}
                            />
                            90's Kid
                        </label>
                        <label>
                            <input
                                type="checkbox"
                                value="coding"
                                checked={profileData.interests.includes("coding")}
                                onChange={handleInterestsChange}
                            />
                            Coding
                        </label>
                ...
                <div className="flex justify-center gap-3">
                        <label>
                            <input
                                type="checkbox"
                                value="tea"
                                checked={profileData.interests.includes("tea")}
                                onChange={handleInterestsChange}
                            />
                            Tea
                        </label>
                        <label>
                            <input
                                type="checkbox"
                                value="coffee"
                                checked={profileData.interests.includes("coffee")}
                                onChange={handleInterestsChange}
                            />
                            Coffee
                        </label>
                        <label>
                            <input
                                type="checkbox"
                                value="diy"
                                checked={profileData.interests.includes("diy")}
                                onChange={handleInterestsChange}
                            />
                            DIY
                        </label>
                        <label>
                            <input
                                type="checkbox"
                                value="arts"
                                checked={profileData.interests.includes("arts")}
                                onChange={handleInterestsChange}
                            />
                            Arts
                        </label>
                        <label>
                            <input
                                type="checkbox"
                                value="comedy"
                                checked={profileData.interests.includes("comedy")}
                                onChange={handleInterestsChange}
                            />
                            Comedy
                        </label>
                        <label>
                            <input
                                type="checkbox"
                                value="cat-lover"
                                checked={profileData.interests.includes("cat-lover")}
                                onChange={handleInterestsChange}
                            />
                            Cat lover
                        </label>
                        <label>
                            <input
                                type="checkbox"
                                value="dog-lover"
                                checked={profileData.interests.includes("dog-lover")}
                                onChange={handleInterestsChange}
                            />
                            Dog lover
                        </label>
                        <label>
                            <input
                                type="checkbox"
                                value="movies"
                                checked={profileData.interests.includes("movies")}
                                onChange={handleInterestsChange}
                            />
                            Movies
                        </label>
